Websoft9 Prestashop Stack 1.7.5.0
...
Websoft9 Prestashop stack is an easy to install and easy to use open source Web 
Platform. It combines leading open source projects, such as Prestashop,PHP,MYSQL,phpMyAdmin,Apache...


2. COMPONENTS and Version

Websoft9 Prestashop stack ships with the following software versions:
...
中文文档：http://support.websoft9.com/docs/prestashop-image-guide/
English: https://en.websoft9.com/docs/prestashop
