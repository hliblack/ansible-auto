...
Websoft9 Discuz stack is an easy to install and easy to use open source Web 
Platform. It combines leading open source projects, such as PHP,MYSQL,phpMyAdmin,Apache...


2. COMPONENTS and Version

Websoft9 Discuz stack ships with the following software versions:
...
中文文档：http://support.websoft9.com/docs/discuz-image-guide/
English: https://en.websoft9.com/docs/discuz
